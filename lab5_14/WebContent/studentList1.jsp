...
<%@ page import="java.util.*, java.net.*,lab5_14.*" %>
...
String srchText = request.getParameter("srchText"); //내가 검색한 이름값 받아오기.
if (srchText == null) srchText = ""; //null일 땐 공백.
String srchTextEncoded = URLEncoder.encode(srchText, "UTF-8"); //UTF-8로 인코딩해주기.

int recordCount = StudentDAO.count(srchText); //검색한 값 DB 불러오기.
