...
<%@ page import="lab6_16.*, java.net.*, java.util.*" %>
<%
request.setCharacterEncoding("UTF-8");

String 에러메시지 = null;
String s1 = request.getParameter("id");
int id = ParseUtils.parseInt(s1, 0); //null=>0
...
<form method="post">
  ...
  <a href="StudentDelete.jsp?id=<%= id %>&pg=<%= pg %>&srchText=<%= srchTextEncoded %>" 
     class="btn btn-danger" onclick="return confirm('삭제하시겠습니까?')">
    <i class="glyphicon glyphicon-trash"></i> 삭제
  </a>
  <a href="StudentList.jsp?pg=<%= pg %>&srchText=<%= srchTextEncoded %>" 
