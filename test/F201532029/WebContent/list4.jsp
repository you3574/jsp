...
<%@ page import="java.util.*, java.net.*, F201532029.*, java.text.*" %>
...
int recordCount = bookDAO.count2(ss, st);

int lastPage = Math.max(1, (recordCount + pageSize - 1) / pageSize);
if (currentPage > lastPage) currentPage = lastPage;

List<Book> list = bookDAO.findAll4(currentPage, pageSize, ss, st);
...
<form class="form-inline">
 ...
 <a class="btn" href="list4.jsp?pg=1"> 검색취소</a> 
